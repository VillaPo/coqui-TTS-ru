...
print(f"Файл метаданных: {os.path.join(config_dataset.path, config_dataset.meta_file_train)}")
...
def main():
    ...
    config = GPTTrainerConfig(
        ...
        test_sentences=[
            {
                "text": "Кри́тика ми́ра и со́бственной биогра́фии. Вме́сте со стено́й костемо́льного заво́да ру́хнула и на́ша уве́ренность в благополу́чии могу́щественного пле́мени взро́слых.",
